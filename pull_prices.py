...
STREAMS = [
    ("oil_prices", "oil_prices.csv", "petroleum/pri/spt",   "RWTC",    "weekly", "pric
    ("gas_prices", "gas_prices.csv", "natural-gas/pri/fut", "RNGWHHD", "daily",  "pric
    ("ngl_prices", "ngl_prices.csv", "petroleum/pri/spt",
def run():
    results = []
